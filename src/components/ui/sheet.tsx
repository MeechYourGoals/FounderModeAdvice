...
const sheetVariants = cva(
  "glass-strong fixed z-50 gap-4 p-6 shadow-glass transition ease-[cubic-bezier(0.32,0.72,0,1)] data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
  {
    variants: {
      side: {
    ...
    return (
      <SheetPortal>
        ...
        <SheetPrimitive.Content ref={ref} className={cn(sheetVariants({ side }), className)} {...props}>
          {side === "bottom" && <div className="sheet-grabber -mt-3 mb-1" aria-hidden />}
          {children}
          {!hideClose && (
