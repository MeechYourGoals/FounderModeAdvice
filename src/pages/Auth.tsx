    ...
    <div className="grain relative h-screen flex flex-col items-center justify-center gap-6 p-4" style={{ background: 'var(--gradient-hero)', paddingTop: 'calc(1rem + var(--safe-area-top))', paddingBottom: 'calc(1rem + var(--safe-area-bottom))' }}>
      ...
      <Card className="glass-strong relative w-full max-w-md max-h-[calc(100vh-7rem-var(--safe-area-top)-var(--safe-area-bottom))] overflow-y-auto rounded-3xl shadow-glass animate-scale-in">
        ...
        <CardContent>
          ...
          <>
          {/* Social sign-in leads — founders don't type passwords. Apple sits
              first with equal-or-greater prominence (App Store guideline 4.8);
              the button adapts black-on-light / white-on-dark per Apple HIG. */}
          <div className="space-y-2.5 mb-5">
            <Button
              type="button"
              className="w-full min-h-11 rounded-xl bg-foreground text-background shadow-sm hover:bg-foreground/90 hover:shadow-md active:bg-foreground/85 bg-none"
            ...
            >
              {appleLoading ? (
                ...
                <svg className="mr-2 h-[18px] w-[18px]" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
          ...
          <div className="relative mb-5">
            <div className="absolute inset-0 flex items-center">
              <span className="w-full hairline-t" />
            </div>
            <div className="relative flex justify-center">
              <span className="bg-transparent px-2 text-caption-1 uppercase tracking-wide text-foreground-tertiary">
