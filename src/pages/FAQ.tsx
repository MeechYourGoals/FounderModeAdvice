...
const FAQS: { q: string; a: React.ReactNode }[] = [
  {
    ...
    a: "Founder Mode Advice turns founder, investor, and operator content into transcript-grounded operating memos — lessons, risks, action items, and follow-up Q&A — tailored to your company, stage, and next decision. Instead of reading and watching for hours, you paste a link and get structured intelligence you can act on, with every recommendation cited back to the source.",
  },
  {
  ...
  },
  {
    ...
    a: "Almost any public URL — articles, blogs, Substack posts, LinkedIn or X posts, newsletters, videos from YouTube, TikTok, Instagram, Vimeo, and most podcasts. Paid tiers can also upload private documents — PDF, TXT, Markdown, CSV, DOCX, and images. Private or login-gated posts aren't supported. You're responsible for ensuring you have the right to submit a given link or file.",
  },
  {
  ...
  },
  {
    ...
    a: "The C-Suite ($9.99/month) includes 20 source analyses per month, up to 5 business profiles, folder organization, and personalized insights tuned to your industry and stage. Analyses are still submitted one target profile at a time.",
  },
  {
  ...
  },
  {
    ...
    a: "Our AI analyzes the source you submit along with the context in your business profile, then surfaces and ranks the most relevant, actionable lessons for you. The Ask-the-video chat only answers questions about the source and your business — not unrelated topics. Advice is informational only and is not professional, legal, or financial advice — always use your own judgment.",
  },
  {
...
const FAQ = () => {
  usePageMeta({ title: "FAQ", description: "Answers on supported sources, plans, pricing, cancellation, and how transcript-grounded analysis works.", path: "/faq" });
