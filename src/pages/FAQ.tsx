...
const FAQS: { q: string; a: React.ReactNode }[] = [
  {
    ...
    a: "Founder Mode Advice turns articles, posts, videos, newsletters, and uploaded documents into source-grounded operating memos — lessons, risks, action items, and follow-up Q&A — tailored to your company, stage, and next decision. Instead of reading or watching for hours, you submit a link or file and get structured intelligence you can act on, with every recommendation cited back to the source.",
  },
  {
    q: "Do I need an account to analyze a source?",
  ...
  {
    q: "What kinds of sources can I analyze?",
    a: "Almost any public URL — articles, Substack posts, LinkedIn and X posts, YouTube, TikTok, Instagram, Vimeo, podcasts, and more. Private or login-gated links often fail; premium users can upload PDF, TXT, MD, or CSV files instead. You're responsible for ensuring you have the right to submit a given link or file.",
  },
  {
    q: "How do company profiles work?",
    a: "Create a profile for each company, venture, or project — with its name, description, industry, stage, and context. The selected profile tailors every analysis (and, on The Boardroom, every source chat) to that company and the decision you're weighing.",
  },
  {
  ...
  },
  {
    ...
    a: "The C-Suite ($9.99/month) includes 20 analyses per month, private document uploads, up to 5 business profiles, folder organization, and personalized insights tuned to your industry and stage. Analyses are still submitted one target profile at a time.",
  },
  {
    q: "What is included in The Boardroom plan?",
    a: "The Boardroom ($19.99/month) includes unlimited analyses, private document uploads, unlimited business profiles, one-click multi-profile batch analysis for the same source, unlimited Ask-this-source chat, and invite-based collaboration so teammates and advisors can view shared insights.",
  },
  {
  ...
  },
  {
    ...
    a: "Our AI analyzes the source you submit along with the context in your business profile, then surfaces and ranks the most relevant, actionable lessons for you. The Ask-this-source chat only answers questions about the content and your business — not unrelated topics. Advice is informational only and is not professional, legal, or financial advice — always use your own judgment.",
  },
  {
...
const FAQ = () => {
  usePageMeta({ title: "FAQ", description: "Answers on supported sources, plans, pricing, cancellation, and how source-grounded analysis works.", path: "/faq" });
