...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.video_chat_sessions TO authenticated;
GRANT ALL ON public.video_chat_sessions TO service_role;
...
GRANT SELECT, INSERT ON public.video_chat_messages TO authenticated;
GRANT ALL ON public.video_chat_messages TO service_role;
